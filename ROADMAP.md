...
## Fase 1 — Percorso 7: Persistenza — fatta

Fatti **P7.0** → **P7.8**. Sei capitoli, README, sette diagrammi in `7.Persistenza/img/`, e il debito chiuso in cinque punti: `3.DDD-tattico/2.value-object.md`, `4.aggregate.md`, `5.use-case-e-dominio.md`, `4.Hexagonal-architecture/5.perche-usarla.md` e `6.sintesi.md`.
