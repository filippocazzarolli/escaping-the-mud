...
| **Test** | Un port, due adapter — [il percorso](../9.Test/README.md) |
...
Il core è protetto, e il primo adapter che serve davvero è quello che conserva lo stato: il [percorso sulla persistenza](../7.Persistenza/README.md) — aggregate e tabelle, repository come port, chi apre la transazione.

A lato, gli [appunti sulla complessità](../5.PhilosophyofSoftwareDesign/README.md) chiedono quanto debba essere profondo ciò che sta dentro.
