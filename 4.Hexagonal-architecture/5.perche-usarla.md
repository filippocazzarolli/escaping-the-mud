...
L'adapter si innesta dopo. Il port c'era già — e [cosa ci va dietro](../7.Persistenza/2.repository-e-un-port.md) è un percorso a sé.

## Libertà di stile

Hexagonal **non ti obbliga** a un'unica convenzione.

- **Vuoi DDD?** Puoi farlo. Entità, value object, aggregate: stanno nel core — come nel [percorso 3](../3.DDD-tattico/README.md), dentro i [confini](../2.DDD-strategico/README.md) del percorso 2.
...
Se non riesci a scrivere il secondo, il port probabilmente **non è un contratto abbastanza pulito**. Il [percorso sui test](../9.Test/2.un-port-due-adapter.md) prende quella regola e la gira in una suite.
