...
← [Il mapping sta nell'adapter](3.mapping-nell-adapter.md) · [Indice](README.md)
...
<!-- P7.7 — img/04-transazione-use-case.png: lo use case che apre e chiude il confine intorno a carica-decide-salva, con mail ed evento fuori dal riquadro -->
...
← [3. Il mapping sta nell'adapter](3.mapping-nell-adapter.md) · [Indice](README.md)
