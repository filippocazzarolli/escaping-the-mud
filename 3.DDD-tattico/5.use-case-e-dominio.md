...
Lo use case, più avanti, parlerà a **porte** (carica, salva, notifica). Il modello no. Una frase: nel [percorso sull'esagono](../4.Hexagonal-architecture/README.md) quella sequenza sta sul bordo del core. La regola resta dove l'abbiamo messa.

La fatica sta nell'aggregate. Lo use case resta sottile — stesso gesto del percorso sulla complessità, quando arriverà.
